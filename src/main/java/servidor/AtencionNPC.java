...
public class AtencionNPC {
	...
	public static void cargarNPC(){
		...
		PaqueteNpc lucas2 = new PaqueteNpc(2, "Lucaneitor2", PaqueteNpc.LUCANEITOR, 2,1, 500, 700, Estado.getEstadoJuego(),1,1 );
		...
		PaqueteNpc leo = new PaqueteNpc(5, "Leo-nidas", PaqueteNpc.LEONIDAS, 2, 1, -1850, 1130, Estado.getEstadoJuego(),1,1);
		Servidor.getPersonajesNPC().put(5, leo);
		PaqueteNpc leo1 = new PaqueteNpc(6, "Leo-nidas1", PaqueteNpc.LEONIDAS, 2, 1, -850, 800, Estado.getEstadoJuego(),1,1);
		...
		PaqueteNpc leo4 = new PaqueteNpc(9, "Leo-nidasPruebas", PaqueteNpc.LEONIDAS, 2, 1, 50, 250, Estado.getEstadoJuego(),1,1);
